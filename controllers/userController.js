...
exports.userRegister=async(req,res)=>{
    try{
        ...
        if(!email || !username || !password){
            ...
            const newUser=new users({email,username,password,profile:"",github:"",linkdin:""})
            await newUser.save()
...
exports.userUpdation=async(req,res)=>{
    try{
        ...
        const result=await users.findByIdAndUpdate(userId,{username,github,profile,linkdin})
